...
class CalibrationMethod {
 ...
 public:
  ...
  void AddData(const std::complex<DataFloatType> *data, const float *weights,
  ...
  const std::complex<double> &JonesSolution(size_t antenna,
                                            size_t polarization) const {
  ...
  void SetOnlySolveDiag(bool onlySolveDiag) { _onlySolveDiag = onlySolveDiag; }
