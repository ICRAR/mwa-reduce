...
class SubbandPassband {
 public:
  static void GetSubbandPassband(std::vector<double> &passband,
                                 std::size_t channelsPerSubband);

 private:
  /**
   * See the cpp file for explanation of the difference between these
   * bandpasses.
   */
