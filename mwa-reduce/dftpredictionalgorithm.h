...
public:
	...
	void Predict(std::complex<double> *dest, double u, double v, double w, size_t channelIndex, size_t a1, size_t a2);

	void UpdateBeam();
	
private:
	void predict(std::complex<double> *dest, double u, double v, double w, size_t channelIndex, size_t a1, size_t a2, DFTPredictionComponent& component);
	
	DFTPredictionInput& _input;
	BandData _band;
	LBeamEvaluator* _beamEvaluator;
};
