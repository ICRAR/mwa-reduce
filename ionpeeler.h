...
class IonPeeler {
 ...
 private:
  ...
  static int posMinimizationFunc(const gsl_vector* xvec, void* data,
                                 gsl_vector* f);
  static int posMinimizationFuncDeriv(const gsl_vector* xvec, void* data,
                                      gsl_matrix* J);
  static int posMinimizationFuncBoth(const gsl_vector* x, void* data,
  ...
  size_t _cpuCount;
  aocommon::UVector<size_t> _failedConvergencesPerSource,
      _failedConvergencesPerChannelGroup;
