...
class RMSynthesis {
 public:
  ...
  const aocommon::UVector<double>& FDF() const { return _fdf; }

  double IndexToValue(size_t i) const {
    return (double(i) - double(_fdf.size() / 2)) * 0.5;
  }  // TODO
